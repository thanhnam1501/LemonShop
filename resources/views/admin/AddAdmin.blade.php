...
<form action="{{route('add_admin')}}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr>	
				<th>Giới tính</th>
				<td>
					<input type="radio" name="gender" value="0"><span>Nam</span>		
	...
	{{csrf_field()}}
	<button type="submit" class="btn-primary btn">Đăng ký thành viên</button>
</form>
