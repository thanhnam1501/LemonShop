...
<html lang="en">
	<head>
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="{{asset('css/admin/ace-part2.min.css')}}" />
		<![endif]-->
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Lemon</span>
									<span class="white" id="id-text2">Shopping</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Thành Nam Corp</h4>
							</div>
