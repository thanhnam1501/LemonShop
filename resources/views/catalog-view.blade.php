        ...
        <div class="fullwidthbanner">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
                    <!-- MAIN IMAGE -->
                    <img src="http://lemonshop.com/image_link/slide1.jpg"  alt="Image" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
                    <!-- MAIN IMAGE -->
                    <img src="http://lemonshop.com/image_link/slide3.jpg"  alt="Image" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                                            ...
                                            <div class="block-caption1 wv_single_heading">
                                                ...
                                                <div class="price list_price col-md-12">
                                                    ...
                                                    <ul class="shop_list_icon wv_single_icon">
                                                        <li><a href="javascript:;" class="addToCart">ADD TO CART</a></li>
            ...
            function showProduct(id){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        var data = res.data;
                        console.log(data)
                        $('#namequickView').html(data.name);
                        $('#sort-content-quickView').html(data.sort_content);
                        $('#price-quickView').html(data.price);
                        $('#price-discount-quickView').html(data.price_discount);
                        $('#supplier-name-quickView').html(data.supplier_name);
                        $("#image-link-quickView").attr("src", data.image_link);
                        $('#catalog-name-quickView').html(data.catalog_name);
