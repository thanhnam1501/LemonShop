...
<head>
	...
	<!-- text fonts -->
	<link rel="stylesheet" href="{{asset('css/admin/fonts.googleapis.com.css')}}" />
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue dropdown-modal">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							{{-- <img class="nav-user-photo" src="assets/images/avatars/user.jpg" alt="'s Photo" /> --}}
						...
						<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							...
							<li>
								...
								<a href="{{route('admin.logout')}}"><i class="ace-icon fa fa-sign-out" aria-hidden="true"></i> Đăng Xuất</a>
...
<![endif]-->
<script type="text/javascript">
	if('ontouchstart' in document.documentElement) document.write("<script src='{{asset('/js/admin/jquery.mobile.custom.min.js')}}'>"+"<"+"/script>");
</script>
...
<!-- page specific plugin scripts -->
		...
		<script src="{{asset('js/admin/jquery.easypiechart.min.js')}}"></script>
		<script src="{{asset('js/admin/jquery.sparkline.index.min.js')}}"></script>
